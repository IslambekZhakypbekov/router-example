...
import spyder from "../../images/spyder.jpg"
...
import Deadpool from "./components/Deadpool/Deadpool"
import Wolverine from "./components/Wolverine/Wolverine"
import SpiderMan from "./components/Spider-Man/Spider-Man"
import AntMan from "./components/AntMan/AntMan"
    ...
    <div className={classes.cards}>
      <div className={classes.groot}>
        ...
        <div className={classes.heading}>
          <Link to="/groot" className={classes.link}>I'm Groot...</Link>
      ...
      <div className={classes.deadpool}>
        ...
        <div className={classes.heading}>
          <Link to="/deadpool" className={classes.link}>Deadpool</Link>
          <Route path="/deadpool" component={Deadpool}></Route>
        </div>
      ...
      <div className={classes.Wolverine}>
        <img src={spyder} alt="Wolverine" />
        <div className={classes.heading}>
          <Link to="/wolverine" className={classes.link}>Wolverine</Link>
          <Route path="/wolverine" component={Wolverine}></Route>
        </div>
      ...
      <div className={classes.spider_man}>
        <img src={blackspyder} alt="Spyder-Man" />  
        <div className={classes.heading}> 
        <Link to="/spiderman" className={classes.link}> Spider-Man</Link>
          <Route path="/spiderman" component={SpiderMan}></Route>
        </div>
      ...
      <div className={classes.ant_man}>
        ...
        <div className={classes.heading}>
        <Link to="/antman" className={classes.link}>Ant Man</Link>
        <Route path="/antman" component={AntMan}></Route>
        </div>
      ...
      <div className={classes.hulk}>
        ...
        <div className={classes.heading}>
        <Link to="/hulk" className={classes.link}>Hulk</Link>
        <Route path="/hulk" component={Hulk}></Route></div>
      ...
      <div className={classes.ds}>
        ...
        <div className={classes.heading}>
        <Link to="/strange" className={classes.link}>Doctor Strange</Link>
        <Route path="/strange" component={Strange}></Route>
          </div>
